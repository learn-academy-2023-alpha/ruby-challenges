# Ruby Challenges
This repository holds the Ruby pair programming challenges for the 2023 Alpha cohort.
...
- Branch name: `topic-initials1-initials2` (ex. state-em-nr)
- Project name: `topic-student1-student2` (ex. state-elyse-nicole)
